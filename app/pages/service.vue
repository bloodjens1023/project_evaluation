  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg">
      <div class="px-4 py-4 flex items-center max-w-3xl mx-auto w-full">
        <button 
          @click="goBack" 
          class="mr-4 p-2 hover:bg-blue-500 rounded-full transition-colors duration-200"
          aria-label="Retour"
        >
        ...
        <h1 class="text-xl font-semibold flex-1 text-center">Service Client</h1>
        <div class="w-10"></div>
      </div>
    </div>
    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
      ...
      <div v-if="loading" class="flex flex-col items-center justify-center py-12">
        ...
        <p class="text-gray-500">Chargement des options...</p>
      </div>
